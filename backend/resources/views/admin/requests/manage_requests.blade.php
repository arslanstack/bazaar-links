                        ...
                        <table id="manage_tbl" class="table table-striped table-bordered dt-responsive" style="width:100%">
                            ...
                            <tbody>
                                ...
                                <tr class="gradeX">
                                    ...
                                    <td>
                                        <a class="btn btn-success btn-sm" href="{{ url('admin/product-requests/detail') }}/{{ $item->id }}">Details</a>
                                        ...
                                        @if ($item->status==1)
                                        <button class="btn btn-warning text-dark btn-sm btn_update_status" data-id="{{$item->id}}" data-status="0" data-text="This action will disable this request and hide it from users' timeline." type="button" data-placement="top" title="Inactivate">Disable</button>
                                        @else
                                        <button class="btn btn-primary btn-sm btn_update_status" data-id="{{$item->id}}" data-status="1" data-text="This action will enable this request and start showing it in users' timeline." type="button" data-placement="top" title="Activate">Enable</button>
                                        @endif
                                    </td>
                                </tr>
                                @endforeach
